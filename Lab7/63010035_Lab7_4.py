...
for i in inp:
    root = T.insert(i)
preOrderLst = T.preOrder(root, [])
inOrderLst = T.inOrder(root, [])
postOrderLst = T.postOrder(root, [])
BFSLst = T.BFS(root)
print(f'Preorder : {printLst(preOrderLst)}')
print(f'Inorder : {printLst(inOrderLst)}')
print(f'Postorder : {printLst(postOrderLst)}')
print(f'Breadth : {printLst(BFSLst)}')